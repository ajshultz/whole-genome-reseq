...
sbatch /n/holylfs/LABS/edwards_lab/ashultz/HFWGReseq/whole-genome-reseq/ANGSD/run_Fst_Intervals.sbatch Eastern_90 Eastern_01 /n/holylfs/LABS/edwards_lab/ashultz/HFWGReseq/angsd/results_saf_merged/Eastern_9001_Autosomal.sfs
sleep 1
