...
then	
	...
	cp ${DIRECTORY}/${SAMPLE}_2.5kbWin_.5kbStep.pestPG ${DIRECTORY}/${SAMPLE}_cat_1.10_2.5kbWin_.5kbStep.pestPG
	
	for i in {1..10}
		do	
		cat ${DIRECTORY}/${SAMPLE}_Int${i}_1kbWin_1kbStep.pestPG | tail -n +2 >> ${DIRECTORY}/${SAMPLE}_cat_1.10_1kbWin_1kbStep.pestPG
		cat ${DIRECTORY}/${SAMPLE}_2.5kbWin_.5kbStep.pestPG | tail -n +2 >> ${DIRECTORY}/${SAMPLE}_cat_1.10_2.5kbWin_.5kbStep.pestPG	
