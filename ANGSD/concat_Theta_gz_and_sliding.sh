...
then	
	...
	cp ${DIRECTORY}/${SAMPLE}_Int1_1kbWin_1kbStep.pestPG ${DIRECTORY}/${SAMPLE}_cat_1.20_1kbWin_1kbStep.pestPG
		cp ${DIRECTORY}/${SAMPLE}_2.5kbWin_.5kbStep.pestPG ${DIRECTORY}/${SAMPLE}_cat_1.20_2.5kbWin_.5kbStep.pestPG
	
	for i in {1..20}
		do	
		cat ${DIRECTORY}/${SAMPLE}_Int${i}_1kbWin_1kbStep.pestPG | tail -n +2 >> ${DIRECTORY}/${SAMPLE}_cat_1.20_1kbWin_1kbStep.pestPG
		cat ${DIRECTORY}/${SAMPLE}_2.5kbWin_.5kbStep.pestPG | tail -n +2 >> ${DIRECTORY}/${SAMPLE}_cat_1.20_2.5kbWin_.5kbStep.pestPG		
