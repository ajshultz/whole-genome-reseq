...
bamlists <- list.files("BamLists_NoRel_Dissertation/BamLists_NoRel")
...
for (file in bamlists){
  ...
  old <- read_table(paste("BamLists_NoRel_Dissertation/BamLists_NoRel/",file,sep=""),col_names = c("path"))
